...
void pulp_nn_linear_lut_u8_i2_i8(
                        uint8_t *pIn,
                        int8_t *pBias,
                        int8_t *pOut,
                        int8_t *pWeight,
                        ...
                        uint8_t flag_batch_norm)
{
    ...
    for(i = start; i < stop; i += 4)
    {
        ...
        for (int j=0; j<(dim_vec >> 2); j++)
        {
          ...
          vecB3 = *((v4s*)pB3);
          vecB4 = *((v4s*)pB4);
          sum = pulp_nn_look_up_u8_i32_i8(pLUT, vecA, vecB, sum);
          sum2 = pulp_nn_look_up_u8_i32_i8(pLUT, vecA, vecB2, sum2);
          sum3 = pulp_nn_look_up_u8_i32_i8(pLUT, vecA, vecB3, sum3);
          sum4 = pulp_nn_look_up_u8_i32_i8(pLUT, vecA, vecB4, sum4);
          pA+=4;
          pB+=4;
          pB2+=4;
          pB3+=4;
