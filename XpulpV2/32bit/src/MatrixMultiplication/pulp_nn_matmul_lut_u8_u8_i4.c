...
uint8_t *pulp_nn_matmul_lut_u8_u8_i4(
                        uint8_t *pIn,
                        int8_t *pBias,
                        uint8_t *pOut,
                        uint8_t *pOut2,
                        ...
                        uint8_t flag_batch_norm)
{
  ...
  for(int i=0; i < (ch_out >> 2); i++)
  {
    ...
    for(int j=0; j<(num_col_im2col_w >> 2); j++)
    {
      ...
      sum = pulp_nn_look_up_u8_i32_i4(pLUT, vecB, vecA[0], sum);
      sum5 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB2, vecA[0], sum5);

      sum = pulp_nn_look_up_u8_i32_i4(pLUT, vecB3, vecA[1], sum);
      sum5 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB4, vecA[1], sum5);

      pA2 = pulp_nn_i4_to_i8(pA2,vecA2);

      sum2 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB, vecA2[0], sum2);
      sum6 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB2, vecA2[0], sum6);

      sum2 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB3, vecA2[1], sum2);
      sum6 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB4, vecA2[1], sum6);

      pA3 = pulp_nn_i4_to_i8(pA3,vecA3);

      sum3 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB, vecA3[0], sum3);
      sum7 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB2, vecA3[0], sum7);

      sum3 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB3, vecA3[1], sum3);
      sum7 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB4, vecA3[1], sum7);

      pA4 = pulp_nn_i4_to_i8(pA4,vecA4);

      sum4 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB, vecA4[0], sum4);
      sum8 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB2, vecA4[0], sum8);

      sum4 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB3, vecA4[1], sum4);
      sum8 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB4, vecA4[1], sum8);
    }
   ...
   while(chan_left)
  {
    ...
    for(int j=0; j < (num_col_im2col_w >> 2); j++)
    {
      ...
      sum = pulp_nn_look_up_u8_i32_i4(pLUT, vecB, vecA[0], sum);
      sum2 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB2, vecA[0], sum2);

      sum = pulp_nn_look_up_u8_i32_i4(pLUT, vecB3, vecA[1], sum);
      sum2 = pulp_nn_look_up_u8_i32_i4(pLUT, vecB4, vecA[1], sum2);
