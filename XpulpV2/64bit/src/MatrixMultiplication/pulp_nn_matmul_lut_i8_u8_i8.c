...
uint8_t *pulp_nn_matmul_lut_i8_u8_i8(
                        int8_t *pIn,
                        int8_t *pBias,
                        uint8_t *pOut,
                        uint8_t *pOut2,
                        ...
                        uint8_t flag_batch_norm)
{
  ...
  for(int i=0; i < (ch_out >> 2); i++)
  {
    ...
    for(int j=0; j<(num_col_im2col_w >> 2); j++)
    {
      ...
      sum = pulp_nn_look_up_i8_i32_i8(pLUT, vecB, vecA, sum );
      sum2 = pulp_nn_look_up_i8_i32_i8(pLUT, vecB, vecA2, sum2);
      sum3 = pulp_nn_look_up_i8_i32_i8(pLUT, vecB, vecA3, sum3);
      sum4 = pulp_nn_look_up_i8_i32_i8(pLUT, vecB, vecA4, sum4);

      sum5 = pulp_nn_look_up_i8_i32_i8(pLUT, vecB2, vecA, sum5);
      sum6 = pulp_nn_look_up_i8_i32_i8(pLUT, vecB2, vecA2, sum6);
      sum7 = pulp_nn_look_up_i8_i32_i8(pLUT, vecB2, vecA3, sum7);
      sum8 = pulp_nn_look_up_i8_i32_i8(pLUT, vecB2, vecA4, sum8);
   ...
   while(chan_left)
  {
    ...
    for(int j=0; j < (num_col_im2col_w >> 2); j++)
    {
      ...
      sum = pulp_nn_look_up_i8_i32_i8(pLUT, vecB, vecA, sum);
      sum2 = pulp_nn_look_up_i8_i32_i8(pLUT, vecB2, vecA, sum2);
