...
void pulp_nn_linear_lut_u4_u2_i8(
                        uint8_t *pIn,
                        int8_t *pBias,
                        uint8_t *pOut,
                        int8_t *pWeight,
                        ...
                        uint8_t flag_batch_norm)
{
    ...
    for(i = start; i < stop; i += 4)
    {
        ...
        for (int j=0; j<(dim_vec >> 3); j++)
        {
          ...
          vecB3[1] = *((v4s*)pB3);
          vecB4[1] = *((v4s*)pB4);
          sum = pulp_nn_look_up_u4_i32_i8(pLUT, vecA[0], vecB[0], sum);
          sum = pulp_nn_look_up_u4_i32_i8(pLUT, vecA[1], vecB[1], sum);
          sum2 = pulp_nn_look_up_u4_i32_i8(pLUT, vecA[0], vecB2[0], sum2);
          sum2 = pulp_nn_look_up_u4_i32_i8(pLUT, vecA[1], vecB2[1], sum2);
          sum3 = pulp_nn_look_up_u4_i32_i8(pLUT, vecA[0], vecB3[0], sum3);
          sum3 = pulp_nn_look_up_u4_i32_i8(pLUT, vecA[1], vecB3[1], sum3);
          sum4 = pulp_nn_look_up_u4_i32_i8(pLUT, vecA[0], vecB4[0], sum4);
          sum4 = pulp_nn_look_up_u4_i32_i8(pLUT, vecA[1], vecB4[1], sum4);
          pA+=4;
          pB+=4;
          pB2+=4;
          pB3+=4;
