/*
 * pulp_nn_depthwise_lut_i8_u8_i2.c
...
void pulp_nn_depthwise_lut_i8_u8_i2(
                        int8_t *pIn,
      ...
      do
      {
        ...
        do
        {
          ...
          do
          {
            v4s w = *(v4s *) pWt;
            v4s x = *(v4s *) pIm2Col;
            sum = pulp_nn_look_up_i8_i32_i2(pLUT, x, w, sum);
            pWt += 4;
            pIm2Col += 4;
            v4s w2 = *(v4s *) pWt2;
            v4s x2 = *(v4s *) pIm2Col2;
            sum2 = pulp_nn_look_up_i8_i32_i2(pLUT, x2, w2, sum2);
            pWt2 += 4;
            pIm2Col2 += 4;
            v4s w3 = *(v4s *) pWt3;
            v4s x3 = *(v4s *) pIm2Col3;
            sum3 = pulp_nn_look_up_i8_i32_i2(pLUT, x3, w3, sum3);
            pWt3 += 4;
            pIm2Col3 += 4;
            v4s w4 = *(v4s *) pWt4;
            v4s x4 = *(v4s *) pIm2Col4;
            sum4 = pulp_nn_look_up_i8_i32_i2(pLUT, x4, w4, sum4);
            pWt4 += 4;
            pIm2Col4 += 4;
            j++;
          }while(j<colCnt);
