/*
 * pulp_nn_depthwise_lut_u4_u2_i4.c
...
void pulp_nn_depthwise_lut_u4_u2_i4(
                        uint8_t *pIn,
      ...
      do
      {
        ...
        do
        {
          ...
          do
          {
            v4s w = *(v4s *) pWt;
            v4u x = *(v4u *) pIm2Col;
            sum = pulp_nn_look_up_u4_i32_i4(pLUT, x, w, sum);
            pWt += 4;
            pIm2Col += 4;
            v4s w2 = *(v4s *) pWt2;
            v4u x2 = *(v4u *) pIm2Col2;
            sum2 = pulp_nn_look_up_u4_i32_i4(pLUT, x2, w2, sum2);
            pWt2 += 4;
            pIm2Col2 += 4;
            v4s w3 = *(v4s *) pWt3;
            v4u x3 = *(v4u *) pIm2Col3;
            sum3 = pulp_nn_look_up_u4_i32_i4(pLUT, x3, w3, sum3);
            pWt3 += 4;
            pIm2Col3 += 4;
            v4s w4 = *(v4s *) pWt4;
            v4u x4 = *(v4u *) pIm2Col4;
            sum4 = pulp_nn_look_up_u4_i32_i4(pLUT, x4, w4, sum4);
            pWt4 += 4;
            pIm2Col4 += 4;
            j++;
          }while(j<colCnt);
